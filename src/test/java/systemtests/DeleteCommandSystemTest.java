...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedModule);
        ...
        expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedModule);
    ...
    private Module removePerson(Model model, Index index) {
        Module targetModule = getPerson(model, index);
        model.deletePerson(targetModule);
        return targetModule;
    }
