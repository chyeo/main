...
import static pwe.planner.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    public void parseKeyword() {
        ...
        String sentenceKeyword = "abc xyz";
        assertFalse(ParserUtil.parseKeyword(sentenceKeyword, actualWord));

        assertTrue(ParserUtil.parseKeyword(sentenceKeyword, sentence));
