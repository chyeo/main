...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_CODE_AMY + VALID_PHONE_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditModuleDescriptor descriptor = new EditModuleDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withCode(VALID_CODE_AMY)
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_MODULE;
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + CODE_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + CODE_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_BOB + CODE_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC + CODE_DESC_BOB
                + PHONE_DESC_BOB;
