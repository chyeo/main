...
public class JsonAdaptedModuleTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(INVALID_NAME, VALID_CREDITS, VALID_EMAIL, VALID_CODE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(null, VALID_CREDITS, VALID_EMAIL, VALID_CODE, VALID_TAGS);
    ...
    public void toModelType_invalidCredits_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_NAME, INVALID_CREDITS, VALID_EMAIL, VALID_CODE, VALID_TAGS);
    ...
    public void toModelType_nullCredits_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(VALID_NAME, null, VALID_EMAIL, VALID_CODE, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_NAME, VALID_CREDITS, INVALID_EMAIL, VALID_CODE, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(VALID_NAME, VALID_CREDITS, null, VALID_CODE, VALID_TAGS);
    ...
    public void toModelType_invalidCode_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_NAME, VALID_CREDITS, VALID_EMAIL, INVALID_CODE, VALID_TAGS);
    ...
    public void toModelType_nullCode_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(VALID_NAME, VALID_CREDITS, VALID_EMAIL, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_NAME, VALID_CREDITS, VALID_EMAIL, VALID_CODE, invalidTags);
